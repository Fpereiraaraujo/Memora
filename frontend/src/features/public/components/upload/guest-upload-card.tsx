    ...
    <section id="upload" className="grid gap-6 lg:grid-cols-[0.86fr_1.14fr]">
      <div className="rounded-[24px] border border-[#f1ddd1] bg-white p-6 shadow-[0_22px_60px_rgba(96,60,36,0.08)]">
        ...
        <p className="mt-4 text-sm leading-7 text-[#2c2927]/66">
          O envio é simples: escolha uma foto, coloque seu nome se quiser, deixe um recado e envie para a galeria do evento.
        </p>

        <div className="mt-6 space-y-3">
          {[
            ['Escolha uma imagem', 'Pode ser uma foto da cerimônia, festa, decoração ou bastidores.'],
            ['Deixe um recado', 'Mensagem é opcional, mas deixa a lembrança mais especial.'],
            ['Envie em segundos', 'A foto aparece na galeria pública e no painel dos anfitriões.'],
        ...
        <div className="mt-6 rounded-[18px] bg-[#161314] p-5 text-white">
          ...
          <p className="mt-3 text-sm leading-7 text-white/72">
            Ao enviar, você permite que os responsáveis pelo evento vejam essa imagem e que ela apareça na galeria pública do evento.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={onSubmit} className="rounded-[24px] border border-[#f1ddd1] bg-white p-6 shadow-[0_22px_60px_rgba(96,60,36,0.08)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-xl font-black text-[#161314]">Carregar foto</h2>
            <p className="mt-3 text-sm leading-7 text-[#2c2927]/64">Escolha uma imagem do seu celular ou computador.</p>
          </div>
        ...
        <label htmlFor="guest-photo-file" className="mt-6 block cursor-pointer rounded-[22px] border border-dashed border-[#efb6bb] bg-[#fff7f7] p-4 text-center transition hover:-translate-y-0.5 hover:border-[#ef7885] hover:bg-white">
          ...
          {previewUrl ? (
            <div className="relative overflow-hidden rounded-[18px]">
              <img src={previewUrl} alt="Pré-visualização da foto" className="h-[280px] w-full object-cover" />
            ...
            <div className="flex min-h-[280px] flex-col items-center justify-center px-4">
              ...
              <p className="mt-5 text-base font-black text-[#161314]">Toque para escolher uma foto</p>

              <p className="mt-2 max-w-sm text-sm leading-6 text-[#2c2927]/58">
                JPG, PNG, WEBP ou HEIC. Envie uma foto que você gostaria que os anfitriões guardassem.
              </p>
            </div>
          )}
        </label>
        ...
        {file ? (
          <div className="mt-4 rounded-[18px] border border-[#f1ddd1] bg-[#fffaf7] p-4">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#c5922e]">Arquivo selecionado</p>
