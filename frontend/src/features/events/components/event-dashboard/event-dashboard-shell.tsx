        ...
        <header className="sticky top-4 z-40 rounded-[22px] border border-[#f1ddd1] bg-white/90 px-4 py-3 shadow-[0_18px_50px_rgba(96,60,36,0.08)] backdrop-blur sm:px-5">
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-[14px] bg-[#ef7885] px-4 text-sm font-bold text-white shadow-[0_14px_34px_rgba(239,120,133,0.22)] transition hover:-translate-y-0.5 hover:bg-[#e86d7b]"
